...
const Sprites_path = "res://Resources/Images/CharacterDialogue/"
...
@onready var Character_Sprite: TextureRect = $Balloon/Character
...
func SetSprite(Character:String, Sprite:String, Size:Vector2 = Vector2(250,250), Position:Vector2 = Vector2(60,220)):
	...
	if texture:
		...
		Character_Sprite.size = Size
		Character_Sprite.position = Position
		Character_Sprite.texture = texture
	else:
		print("ERRORE, TEXTURE SBAGLIATA")
